...
class BasicBlock
  ...
  attr_accessor :inEdges
  attr_accessor :outEdges
end
...
class SimpleLoop
  ...
  attr_accessor :isReducible
  attr_accessor :isRoot
  attr_accessor :parent
  attr_accessor :depthLevel
  attr_accessor :children
  attr_accessor :nestingLevel
...
class HavlakLoopFinder
  ...
  def findLoops
    ...
    nonBackPreds    = Array.new(size) { Array.new }
    backPreds       = Array.new(size) { Array.new }
    number          = {}
        ...
        while !workList.empty?
          ...
          nonBackPreds[x.dfsNumber].each do |iter|
            ...
            if !isAncestor(w, ydash.dfsNumber, last)
              ...
              if ydash.dfsNumber != w && !nodePool.include?(ydash)
                workList << ydash
                nodePool << ydash
              end
            end
